...
Open sourced the converter - [one command](https://github.com/thellimist/clihub) to create CLIs from MCPs. To be released soon - [message me](https://x.com/thellimist) for early access.

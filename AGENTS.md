# AGENTS.md — kanyilmaz.me Blog

## Key Files

| File | Purpose |
|------|---------|
| `VOICE.md` | Kan's writing voice, tone, anti-slop rules. Read before writing anything. |

## Skills

| Skill | Location | When to Use |
|-------|----------|-------------|
| **Blog Writing** | `skills/blog-writing/SKILL.md` | Writing, editing, formatting blog posts. CSS, markdown, file structure. |
| **Blog Image Generation** | `skills/blog-image-generation/SKILL.md` | Generate or edit blog images (header and inline visuals) using Gemini APIs |
| **X Publishing** | `skills/x-publishing/SKILL.md` | Adapting a blog post for X long-form articles |
